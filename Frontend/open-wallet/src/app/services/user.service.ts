...
export class UserService {
  ...
  set currentUser(user: User) {
    if (user) {
      ...
      localStorage.setItem('jwt', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJ1dGVudGVAZXhhbXBsZS5jb20iLCJpYXQiOjE3NTc3NzkyNDYsImV4cCI6MTc1Nzc4NjQ0Nn0.87PPujwP_HRYcKQP_3EiCaRjE_i6PkhpuOdjIUxc02M')
